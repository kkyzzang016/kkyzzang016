...
<article>
	<h1>Login</h1>
	<form method="post" action="ShoppingMallServlet?command=login">
		<fieldset>
			<legend></legend>
		...
		<div id="buttons">
			<input type="submit" value="로그인" class="submit"> <input
				...
				onclick="location='ShoppingMallServlet?command=join_form'"> <input
				type="button" value="아이디 비밀번호 찾기" class="submit"
				onclick="location='ShoppingMallServlet?command=find_id_form'">
		</div>
	</form>
</article>
